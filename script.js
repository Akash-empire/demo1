...
let replies = [
  ...
  // ANIMALS & WILDLIFE (1-100)
  { q: ["what is the fastest land animal", "fastest animal"], a: "The cheetah is the fastest land animal, reaching speeds up to 120 km/h." },
  { q: ["what is the largest land animal", "biggest land animal"], a: "The African Elephant is the largest land animal on Earth." },
  { q: ["how many legs does a spider have", "spider legs count"], a: "Spiders have eight legs." },
  { q: ["what is a group of lions called", "lion group name"], a: "A group of lions is called a pride." },
  { q: ["what is the only mammal that can fly", "flying mammal"], a: "The bat is the only mammal capable of true and sustained flight." },
  { q: ["how many hearts does an octopus have", "octopus heart count"], a: "An octopus has three hearts." },
  { q: ["what is a baby kangaroo called", "kangaroo baby name"], a: "A baby kangaroo is called a joey." },
  { q: ["what is the tallest animal", "tallest land animal"], a: "The giraffe is the tallest living land animal." },
  { q: ["do sharks have bones", "shark skeleton"], a: "No, sharks do not have bones; their skeletons are made of cartilage." },
  { q: ["what is the largest bird in the world", "biggest bird"], a: "The ostrich is the largest and heaviest living bird." },
  { q: ["how long does a giant panda eat", "panda eating habits"], a: "Giant pandas spend 12 to 14 hours a day eating bamboo." },
  { q: ["what is the slowest animal", "slowest mammal"], a: "The three-toed sloth is the slowest mammal in the world." },
  { q: ["can an ostrich fly", "ostrich flight"], a: "No, ostriches are flightless birds, but they are incredibly fast runners." },
  { q: ["what is a female deer called", "deer female name"], a: "A female deer is called a doe." },
  { q: ["what is a male deer called", "deer male name"], a: "A male deer is called a buck." },
  { q: ["how many stomach compartments does a cow have", "cow stomach"], a: "A cow has four stomach compartments." },
  { q: ["what is the largest fish", "biggest fish"], a: "The whale shark is the largest known extant fish species." },
  { q: ["which bird can mimic human speech", "talking bird"], a: "Parrots, especially African Greys, are famous for mimicking human speech." },
  { q: ["what is the lifespan of a lion", "lion age"], a: "In the wild, lions live for about 10 to 14 years." },
  { q: ["how do bees communicate", "bee dance"], a: "Bees communicate the location of food through a 'waggle dance'." },
  { q: ["which animal has the longest lifespan", "oldest living animal"], a: "The Greenland shark can live for over 400 years." },
  { q: ["what is a group of crows called", "crow group name"], a: "A group of crows is called a murder." },
  { q: ["can penguins fly", "penguin flight"], a: "No, penguins are flightless birds, but they are expert swimmers." },
  { q: ["what color is a polar bear's skin", "polar bear skin color"], a: "Underneath their white fur, polar bears actually have black skin." },
  { q: ["how many arms does a jellyfish have", "jellyfish anatomy"], a: "Jellyfish have tentacles rather than arms, and the number varies by species." },
  { q: ["what is the smallest bird", "tiniest bird"], a: "The Bee Hummingbird is the smallest bird in the world." },
  { q: ["what is a group of fish called", "fish group name"], a: "A group of fish is usually called a school or a shoal." },
  { q: ["why do flamingos turn pink", "pink flamingo reason"], a: "Flamingos turn pink because of the carotenoid pigments in the algae and shrimp they eat." },
  { q: ["what is the largest reptile", "biggest reptile"], a: "The Saltwater Crocodile is the largest living reptile." },
  { q: ["how many legs does a centipede have", "centipede legs count"], a: "Despite the name, most centipedes have between 30 and 354 legs." },
  { q: ["what is a baby cat called", "cat baby name"], a: "A baby cat is called a kitten." },
  { q: ["what is a baby dog called", "dog baby name"], a: "A baby dog is called a puppy." },
  { q: ["which animal is known for its humps", "humped animal"], a: "The camel is known for storing fat in its humps." },
  { q: ["what is a group of wolves called", "wolf group name"], a: "A group of wolves is called a pack." },
  { q: ["are bats blind", "blind as a bat"], a: "No, bats are not blind; most have quite good eyesight, but they use echolocation to hunt." },
  { q: ["what is the strongest insect", "strongest bug"], a: "The Dung Beetle is considered the strongest insect for its size." },
  { q: ["how many wings does a bee have", "bee wings count"], a: "A bee has four wings." },
  { q: ["which mammal lays eggs", "egg laying mammal"], a: "The Platypus and the Echidna are the only mammals that lay eggs." },
  { q: ["what is a group of owls called", "owl group name"], a: "A group of owls is called a parliament." },
  { q: ["what is a rhino's horn made of", "rhino horn material"], a: "A rhino's horn is made of keratin, the same protein found in human hair and nails." },
  { q: ["which animal has the largest eyes", "biggest eyes"], a: "The Giant Squid has the largest eyes in the animal kingdom." },
  { q: ["do snakes have ears", "snake hearing"], a: "Snakes do not have external ears, but they can sense vibrations through their jawbones." },
  { q: ["what is the fastest bird", "fastest flyer"], a: "The Peregrine Falcon is the fastest bird, reaching over 320 km/h during a dive." },
  { q: ["what is a group of elephants called", "elephant group name"], a: "A group of elephants is called a herd." },
  { q: ["how many teeth does a shark have", "shark teeth count"], a: "A shark can have thousands of teeth throughout its lifetime." },
  { q: ["what is the most venomous snake", "deadliest snake"], a: "The Inland Taipan is considered the most venomous snake in the world." },
  { q: ["can horses sleep standing up", "horse sleep habits"], a: "Yes, horses have a 'stay apparatus' in their legs that allows them to sleep while standing." },
  { q: ["what is a group of kittens called", "kitten group name"], a: "A group of kittens is called a kindle." },
  { q: ["what is a group of whales called", "whale group name"], a: "A group of whales is called a pod." },
  { q: ["how many species of animals are there", "total animal species"], a: "Scientists estimate there are around 8.7 million species, though most have not yet been discovered." },
  { q: ["do ants sleep", "ant sleep habits"], a: "Yes, ants take many short power naps throughout the day." },
  { q: ["what is the largest primate", "biggest monkey"], a: "The Gorilla is the largest living primate." },
  { q: ["which animal never sleeps", "animal with no sleep"], a: "Bullfrogs are often cited as animals that don't sleep, though they do have periods of rest." },
  { q: ["what is the smartest land animal", "smartest animal"], a: "Chimpanzees and Orangutans are widely considered the smartest non-human land animals." },
  { q: ["what is a group of butterflies called", "butterfly group name"], a: "A group of butterflies is called a kaleidoscope or a flutter." },
  { q: ["how many legs does a butterfly have", "butterfly legs count"], a: "Butterflies are insects, so they have six legs." },
  { q: ["what is a baby owl called", "owl baby name"], a: "A baby owl is called an owlet." },
  { q: ["which animal can change its color", "color changing animal"], a: "The chameleon and the octopus are famous for changing their skin color." },
  { q: ["how long is a giraffe's tongue", "giraffe tongue length"], a: "A giraffe's tongue can be up to 21 inches (53 cm) long." },
  { q: ["what is a group of ants called", "ant group name"], a: "A group of ants is called a colony." },
  { q: ["do fish breathe air", "how fish breathe"], a: "Fish breathe oxygen from the water using their gills." },
  { q: ["what is the largest crab", "biggest crab"], a: "The Japanese Spider Crab is the largest crab by leg span." },
  { q: ["what is a baby swan called", "swan baby name"], a: "A baby swan is called a cygnet." },
  { q: ["which animal can rotate its head 270 degrees", "head rotating animal"], a: "The owl can rotate its head up to 270 degrees." },
  { q: ["what is a group of sheep called", "sheep group name"], a: "A group of sheep is called a flock." },
  { q: ["what is the national animal of australia", "australia national animal"], a: "The Red Kangaroo is the national animal of Australia." },
  { q: ["how many legs does a crab have", "crab legs count"], a: "Crabs have ten legs, including their claws." },
  { q: ["what is a group of flamingos called", "flamingo group name"], a: "A group of flamingos is called a flamboyance." },
  { q: ["what is the heaviest insect", "biggest bug"], a: "The Goliath Beetle is among the heaviest insects in the world." },
  { q: ["can pigs swim", "pig swimming"], a: "Yes, pigs are surprisingly good swimmers." },
  { q: ["what is a group of porcupines called", "porcupine group name"], a: "A group of porcupines is called a prickle." },
  { q: ["how many hearts does a squid have", "squid heart count"], a: "A squid has three hearts." },
  { q: ["what is a baby goat called", "goat baby name"], a: "A baby goat is called a kid." },
  { q: ["what is the smallest mammal", "tiniest mammal"], a: "The Bumblebee Bat is the smallest mammal by length." },
  { q: ["which animal is known as the 'sea cow'", "sea cow animal"], a: "The Manatee is commonly known as the sea cow." },
  { q: ["what is a group of jellyfish called", "jellyfish group name"], a: "A group of jellyfish is called a bloom or a smack." },
  { q: ["can tigers swim", "tiger swimming"], a: "Yes, unlike most cats, tigers love water and are excellent swimmers." },
  { q: ["what is the fastest fish", "fastest swimmer"], a: "The Sailfish is widely considered the fastest fish in the ocean." },
  { q: ["how many legs does a scorpion have", "scorpion legs count"], a: "Scorpions have eight legs." },
  { q: ["what is a group of monkeys called", "monkey group name"], a: "A group of monkeys is called a troop." },
  { q: ["what is a baby bear called", "bear baby name"], a: "A baby bear is called a cub." },
  { q: ["which animal has a blue tongue", "blue tongued animal"], a: "The Blue-tongued Skink and the Chow Chow dog are known for blue tongues." },
  { q: ["what is the largest amphibian", "biggest amphibian"], a: "The Chinese Giant Salamander is the largest amphibian." },
  { q: ["do rabbits have tails", "rabbit tail"], a: "Yes, rabbits have short, fluffy tails called scuts." },
  { q: ["what is a group of zebras called", "zebra group name"], a: "A group of zebras is called a zeal." },
  { q: ["how many eyes does a caterpillar have", "caterpillar eyes"], a: "Most caterpillars have 12 tiny eyes called stemmata." },
  { q: ["what is a baby horse called", "horse baby name"], a: "A baby horse is called a foal." },
  { q: ["which bird can fly backwards", "backward flying bird"], a: "The hummingbird is the only bird that can fly backwards." },
  { q: ["what is the most common bird in the world", "most common bird"], a: "The domestic chicken is the most common bird in the world." },
  { q: ["how long do turtles live", "turtle lifespan"], a: "Many turtle species live for 30 to 70 years, while some tortoises live over 150 years." },
  { q: ["what is a group of penguins called", "penguin group name"], a: "On land, a group of penguins is called a waddle; in the water, a raft." },
  { q: ["what is the only land animal that cannot jump", "animal that can't jump"], a: "The elephant is the only land mammal that cannot jump." },
  { q: ["how many legs does an ant have", "ant legs count"], a: "Ants have six legs." },
  { q: ["what is a baby sheep called", "sheep baby name"], a: "A baby sheep is called a lamb." },
  { q: ["what is the national animal of scotland", "scotland national animal"], a: "The Unicorn is the national animal of Scotland." },
  { q: ["do polar bears eat penguins", "polar bear vs penguin"], a: "No, polar bears live in the Arctic (North), and penguins live in the Antarctic (South)." },
  { q: ["what is the largest bat", "biggest bat"], a: "The Giant Golden-crowned Flying Fox is one of the largest bats." },
  { q: ["what is a group of frogs called", "frog group name"], a: "A group of frogs is called an army." },
  { q: ["which animal has the strongest bite", "strongest bite force"], a: "The Nile Crocodile has the strongest recorded bite force." },
  { q: ["what is the national animal of the usa", "usa national animal"], a: "The Bald Eagle is the national animal of the United States." },

  // HUMAN BODY & BIOLOGY (1-100)
  { q: ["how many bones in an adult", "adult bone count"], a: "An adult human has 206 bones, though they are born with about 270." },
  { q: ["what is the largest organ", "biggest organ"], a: "The skin is the largest organ of the human body." },
  { q: ["how many muscles in the body", "muscle count"], a: "There are approximately 600 to 850 muscles in the human body." },
  { q: ["what is the strongest muscle", "strongest body part"], a: "Based on its weight, the masseter (jaw muscle) is the strongest muscle." },
  { q: ["how many liters of blood", "blood volume"], a: "The average adult has about 4.5 to 5.5 liters of blood." },
  { q: ["what is the smallest bone", "tiniest bone"], a: "The stapes, located in the middle ear, is the smallest bone in the body." },
  { q: ["how many teeth do adults have", "adult teeth count"], a: "A full set of adult teeth typically includes 32 teeth, including wisdom teeth." },
  { q: ["what is the hardest substance in the body", "hardest body part"], a: "Tooth enamel is the hardest substance in the human body." },
  { q: ["how fast does hair grow", "hair growth rate"], a: "On average, human hair grows about 0.5 inches (1.25 cm) per month." },
  { q: ["how many senses do humans have", "human senses"], a: "While the five basic senses are sight, smell, touch, taste, and hearing, humans have many more, like balance and temperature sense." },
  { q: ["what is the longest bone", "biggest bone"], a: "The femur, or thigh bone, is the longest and strongest bone in the body." },
  { q: ["how many times does the heart beat", "heart rate daily"], a: "An average heart beats about 100,000 times a day." },
  { q: ["what percentage of the body is water", "body water percent"], a: "About 60% of the adult human body is made of water." },
  { q: ["how many breaths per day", "breathing count"], a: "An average person takes about 17,000 to 30,000 breaths per day." },
  { q: ["what is the brain made of", "brain composition"], a: "The human brain is about 75% water and is the fattiest organ in the body." },
  { q: ["do fingernails grow faster than toenails", "nail growth"], a: "Yes, fingernails grow about three to four times faster than toenails." },
  { q: ["how many skin cells do we lose", "shedding skin"], a: "Humans shed about 30,000 to 40,000 dead skin cells every minute." },
  { q: ["what is the function of the liver", "what does the liver do"], a: "The liver filters toxins from the blood and produces bile to help with digestion." },
  { q: ["how many taste buds do we have", "taste bud count"], a: "The average person has about 2,000 to 8,000 taste buds." },
  { q: ["can the liver regrow", "liver regeneration"], a: "Yes, the liver is the only organ that can fully regenerate from as little as 25% of its original tissue." },
  { q: ["how long is the small intestine", "small intestine length"], a: "The small intestine is about 20 feet (6 meters) long." },
  { q: ["what color is blood inside the body", "is blood blue"], a: "Blood is always red, even inside your veins. It only looks blue through the skin due to light reflection." },
  { q: ["how much does the brain weigh", "brain weight"], a: "The average adult brain weighs about 3 pounds (1.4 kilograms)." },
  { q: ["what is the pump of the body", "heart function"], a: "The heart acts as a pump that circulates blood throughout the entire body." },
  { q: ["how many ribs do humans have", "rib count"], a: "Most humans have 12 pairs of ribs, totaling 24." },
  { q: ["what part of the eye gives it color", "eye color part"], a: "The iris is the colored part of the eye that controls the amount of light entering." },
  { q: ["where is the funny bone", "uinar nerve"], a: "The 'funny bone' isn't a bone; it's the ulnar nerve running along your elbow." },
  { q: ["how many blood types are there", "blood groups"], a: "There are four main blood groups: A, B, AB, and O, each can be Rh-positive or Rh-negative." },
  { q: ["what is the universal donor blood type", "universal donor"], a: "O-negative is considered the universal donor blood type." },
  { q: ["what is the universal recipient blood type", "universal recipient"], a: "AB-positive is the universal recipient blood type." },
  { q: ["how long does it take to digest food", "digestion time"], a: "It usually takes 24 to 72 hours for food to pass through the entire digestive system." },
  { q: ["what are eyelashes for", "eyelash function"], a: "Eyelashes protect the eyes from debris and moisture." },
  { q: ["how many miles of blood vessels", "blood vessel length"], a: "If laid end-to-end, an adult's blood vessels would stretch over 60,000 miles." },
  { q: ["which lung is smaller", "left vs right lung"], a: "The left lung is slightly smaller to make room for the heart." },
  { q: ["what is the main gas we breathe in", "air composition"], a: "We mostly breathe in nitrogen (78%) and oxygen (21%)." },
  { q: ["do ears ever stop growing", "ear growth"], a: "No, ears and the nose continue to grow throughout a person's life due to gravity and cartilage changes." },
  { q: ["how many blinks per minute", "blinking rate"], a: "The average person blinks about 15 to 20 times per minute." },
  { q: ["what is the role of white blood cells", "wbc function"], a: "White blood cells are the body's primary defense against infections and diseases." },
  { q: ["what are fingerprints for", "purpose of fingerprints"], a: "Fingerprints provide friction for gripping objects and improve our sense of touch." },
  { q: ["can you sneeze with your eyes open", "sneezing eyes"], a: "It is nearly impossible to sneeze with your eyes open due to an autonomic reflex." },
  { q: ["how much air do lungs hold", "lung capacity"], a: "The average total lung capacity of an adult male is about 6 liters." },
  { q: ["what is the epiglottis", "swallowing part"], a: "The epiglottis is a flap of tissue that prevents food from entering the windpipe." },
  { q: ["what causes goosebumps", "why goosebumps"], a: "Goosebumps are caused by tiny muscles at the base of hair follicles contracting, often due to cold or emotion." },
  { q: ["how many nerves are in the body", "nerve count"], a: "There are billions of neurons in the brain and miles of nerves throughout the body." },
  { q: ["what is the thinnest skin", "tiniest skin area"], a: "The skin on the eyelids is the thinnest on the human body." },
  { q: ["what is the thickest skin", "tough skin area"], a: "The skin on the palms of the hands and soles of the feet is the thickest." },
  { q: ["how much sweat do we produce", "sweating volume"], a: "Humans can produce several liters of sweat per day during heavy exercise." },
  { q: ["what is the purpose of sleep", "why we sleep"], a: "Sleep allows the body to repair tissue, synthesize hormones, and consolidate memories." },
  { q: ["which finger is the most sensitive", "sensitive finger"], a: "The index finger is generally the most sensitive finger on the human hand." },
  { q: ["what are hormones", "body chemicals"], a: "Hormones are chemical messengers that travel through the blood to coordinate different functions." },
  { q: ["what is the thyroid gland", "metabolism gland"], a: "The thyroid gland produces hormones that regulate the body's metabolic rate." },
  { q: ["how many facial expressions can we make", "face movements"], a: "Humans are capable of making over 10,000 different facial expressions." },
  { q: ["what is the uvula", "hanging throat part"], a: "The uvula is the fleshy piece hanging at the back of the throat; it helps with speech and saliva." },
  { q: ["what is the smallest cell in males", "sperm cell"], a: "The sperm cell is the smallest cell in the male human body." },
  { q: ["what is the largest cell in females", "egg cell"], a: "The egg cell (ovum) is the largest cell in the female human body." },
  { q: ["how many chromosomes do humans have", "human dna count"], a: "Humans typically have 46 chromosomes in 23 pairs." },
  { q: ["what are platelets for", "blood clotting"], a: "Platelets help the blood clot to stop bleeding after an injury." },
  { q: ["what is the function of the kidneys", "kidney role"], a: "Kidneys filter waste products from the blood and turn them into urine." },
  { q: ["how much of the brain do we use", "brain usage percent"], a: "Humans use virtually every part of the brain; the '10 percent' myth is false." },
  { q: ["what is the aorta", "main artery"], a: "The aorta is the largest artery in the body, carrying blood away from the heart." },
  { q: ["what is plasma", "blood liquid"], a: "Plasma is the yellowish liquid component of blood that holds blood cells in suspension." },
  { q: ["what is the skull for", "cranium purpose"], a: "The skull protects the brain and supports the structure of the face." },
  { q: ["what is cartilage", "flexible bone"], a: "Cartilage is a firm, flexible connective tissue found in joints, the nose, and ears." },
  { q: ["why do we yawn", "yawning reason"], a: "While not fully understood, yawning may help cool the brain or increase alertness." },
  { q: ["how many blood vessels in the eye", "eye veins"], a: "The retina has a dense network of tiny blood vessels to provide oxygen to sight cells." },
  { q: ["what is an appendix", "vestigial organ"], a: "The appendix is a small tube attached to the large intestine; its exact modern function is debated." },
  { q: ["what is the diaphragm", "breathing muscle"], a: "The diaphragm is the main muscle used in the process of inhalation." },
  { q: ["how many hairs on a human head", "head hair count"], a: "The average human head has about 100,000 hair follicles." },
  { q: ["what is the cornea", "eye surface"], a: "The cornea is the transparent front part of the eye that covers the iris and pupil." },
  { q: ["how do we hear", "hearing process"], a: "Sound waves enter the ear, vibrate the eardrum, and are converted into electrical signals for the brain." },
  { q: ["what is hemoglobin", "iron in blood"], a: "Hemoglobin is the protein in red blood cells that carries oxygen." },
  { q: ["what are ligaments", "bone connectors"], a: "Ligaments are tough bands of tissue that connect bones to other bones." },
  { q: ["what are tendons", "muscle connectors"], a: "Tendons are flexible cords of tissue that connect muscles to bones." },
  { q: ["what is the spinal cord", "central nervous system"], a: "The spinal cord is a long bundle of nerves that transmits signals between the brain and the body." },
  { q: ["how many joints in the body", "human joints count"], a: "There are between 250 and 350 joints in the human body." },
  { q: ["what is a pulse", "feeling heart beat"], a: "A pulse is the tactile arterial palpation of the cardiac cycle (heartbeat)." },
  { q: ["what is digestion", "food processing"], a: "Digestion is the breakdown of large insoluble food molecules into small water-soluble food molecules." },
  { q: ["what is the ph of blood", "blood acidity"], a: "Human blood is slightly basic, with a normal pH range of about 7.35 to 7.45." },
  { q: ["how long is the large intestine", "colon length"], a: "The large intestine is about 5 feet (1.5 meters) long." },
  { q: ["what is bile", "stomach liquid"], a: "Bile is a fluid produced by the liver that helps digest fats." },
  { q: ["what is the esophagus", "food pipe"], a: "The esophagus is the muscular tube that carries food from the throat to the stomach." },
  { q: ["what are vertebrae", "backbone pieces"], a: "Vertebrae are the individual bones that make up the spinal column." },
  { q: ["how many vertebrae are there", "spine bone count"], a: "Humans typically have 33 vertebrae." },
  { q: ["what is the pancreas", "insulin organ"], a: "The pancreas produces enzymes for digestion and hormones like insulin." },
  { q: ["what is the gallbladder", "bile storage"], a: "The gallbladder is a small organ that stores bile produced by the liver." },
  { q: ["what is sebum", "skin oil"], a: "Sebum is an oily substance produced by glands in the skin to keep it moisturized." },
  { q: ["what are alveoli", "lung sacs"], a: "Alveoli are tiny air sacs in the lungs where gas exchange occurs." },
  { q: ["how many sweat glands", "sweat gland count"], a: "Humans have between 2 and 4 million sweat glands." },
  { q: ["what is the cerebellum", "little brain"], a: "The cerebellum is the part of the brain that coordinates movement and balance." },
  { q: ["what is the brainstem", "brain base"], a: "The brainstem controls basic life functions like breathing and heart rate." },
  { q: ["what is marrow", "inside of bones"], a: "Bone marrow is the soft tissue inside bones where blood cells are produced." },
  { q: ["what are eyelashes made of", "hair material"], a: "Like all hair, eyelashes are primarily made of a protein called keratin." },
  { q: ["how many layers of skin", "skin layers"], a: "There are three main layers: the epidermis, dermis, and hypodermis." },
  { q: ["what is the pupil", "eye black dot"], a: "The pupil is the opening in the center of the iris that allows light to strike the retina." },
  { q: ["what is a sneeze", "nasal reflex"], a: "A sneeze is a semi-autonomous, convulsive expulsion of air from the nose and mouth." },
  { q: ["what is a cough", "throat reflex"], a: "A cough is a sudden expulsion of air from the lungs to clear the breathing passages." },
  { q: ["what is the solar plexus", "stomach nerves"], a: "The solar plexus is a complex network of nerves located in the abdomen." },
  { q: ["how does the body stay warm", "thermoregulation"], a: "The body stays warm through metabolism, muscle activity (shivering), and blood flow regulation." },
  { q: ["what is an allergy", "immune response"], a: "An allergy is an immune system reaction to a foreign substance that isn't typically harmful." },
  { q: ["can you grow back skin", "skin healing"], a: "Yes, the epidermis constantly regenerates itself to heal wounds and replace old cells." },
